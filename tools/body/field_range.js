...
const readTables = async () => {
  ...
  for (let bodyType of bodyTypes) {
    ...
    const bodyParamFilePath = path.join(__dirname, `../../raw/body/${bodyType}/bodyparam.tab`);
    ...
    const boneParamFilePath = path.join(__dirname, `../../raw/body/${bodyType}/boneparam.tab`);
